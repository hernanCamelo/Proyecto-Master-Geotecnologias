...
QDir.addSearchPath("icons", os.path.dirname(__file__))
...
class Reloader:
    ...
    def initGui(self):
        ...
        icon_path = "icons:layer-reload.png"
        self.add_action(
            icon_path,
        ...
        icon_path = "icons:layer-reopen.png"
        self.add_action(
            icon_path,
        ...
        icon_path = "icons:layer-watch.png"
        self.add_action(
            icon_path,
        ...
        icon_path = "icons:layer-unwatch.png"
        self.add_action(
            icon_path,
